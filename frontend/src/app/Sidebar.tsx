...
export function Sidebar({ open = true, isMobile = false, onNavigate }: SidebarProps) {
  ...
  return (
    ...
    <aside
      ...
      className={`flex flex-col border-r border-byla-navy-border bg-byla-navy transition-all duration-200 ease-out ${mobileClasses}`}
