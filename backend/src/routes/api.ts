...
import programaBolsasRoutes from './programaBolsas.js';
...
import { createDespesasClassificacaoRouter } from './despesasClassificacao.js';
import { createEntradasClassificacaoRouter } from './entradasClassificacao.js';
...
router.use(programaBolsasRoutes);
