...
import { casarVinculosOrfaosPorDataValor } from './vinculosOrfaosHeuristica.js';
...
test('não casa quando dois pagamentos competem pelo mesmo órfão', () => {
  const matches = casarVinculosOrfaosPorDataValor({
    ...
    pagamentos: [
      { id: 'a', alunoKey: 'pilates|1|a', data_pagamento: '2026-05-04', valor: 250 },
      { id: 'b', alunoKey: 'pilates|2|b', data_pagamento: '2026-05-05', valor: 250 },
    ],
  });
